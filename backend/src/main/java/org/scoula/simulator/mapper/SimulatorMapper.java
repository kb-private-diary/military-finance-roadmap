...
public interface SimulatorMapper {
    SimulatorUserDatesDTO findUserDates(Long userId);
    
    // TODO: 향후 openbanking 공식 VO 완성 시 반환 타입을 해당 VO로 변경 (SimulatorSavingAccountDTO 삭제)
    List<SimulatorSavingAccountDTO> findAccountListByUserId(Long userId);
    
    // TODO: 향후 openbanking 공식 VO 완성 시 반환 타입을 해당 VO로 변경 (SimulatorSavingHistoryDTO 삭제)
    List<SimulatorSavingHistoryDTO> findHistoryListByAccountId(Long accountId);
}
