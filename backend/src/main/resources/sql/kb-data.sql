...
-- --------------------------------------------------------------------
--  [수연] 수입 income (급여) - 입대일부터 계급 진급 반영 월별 급여
--  실제로는 오픈뱅킹 연동 시 saveSalaries가 계급별 급여를 매월 10일 동적 적재
--  spending(지출)과 대칭이 맞아야 후회소비 수입대비 비율이 계산됨
--  각 회원 입대 다음달~2026-08 매월 10일, 그 시점 계급의 급여(RankCalculator 기준).
--  진급 구간: 복무 1~2개월 이병(75만)/3~8 일병(90만)/9~14 상병(120만)/15+ 병장(150만).
--    - monthsSinceEnlist = 입대월을 1개월째로 카운트(입대월 포함) → 입대 다음달이 2개월째(이병 말).
--  회원1(2026-01 입대): 02 이병 → 03~08 일병
--  회원2(2025-11 입대): 12 이병 → 2026-01~06 일병 → 07~08 상병
--  회원3(2026-02 입대): 03 이병 → 04~08 일병
-- --------------------------------------------------------------------
INSERT INTO income (income_id, user_id, source, category, amount, received_at, created_date, created_nm, del_yn) VALUES
-- 회원1 (2026-01 입대)
(1,  1, '국군재정관리단', 'SALARY',  750000, '2026-02-10 09:00:00', NOW(), 'BATCH', 'N'),
(2,  1, '국군재정관리단', 'SALARY',  900000, '2026-03-10 09:00:00', NOW(), 'BATCH', 'N'),
(3,  1, '국군재정관리단', 'SALARY',  900000, '2026-04-10 09:00:00', NOW(), 'BATCH', 'N'),
(4,  1, '국군재정관리단', 'SALARY',  900000, '2026-05-10 09:00:00', NOW(), 'BATCH', 'N'),
(5,  1, '국군재정관리단', 'SALARY',  900000, '2026-06-10 09:00:00', NOW(), 'BATCH', 'N'),
(6,  1, '국군재정관리단', 'SALARY',  900000, '2026-07-10 09:00:00', NOW(), 'BATCH', 'N'),
(7,  1, '국군재정관리단', 'SALARY',  900000, '2026-08-10 09:00:00', NOW(), 'BATCH', 'N'),
-- 회원2 (2025-11 입대)
(8,  2, '국군재정관리단', 'SALARY',  750000, '2025-12-10 09:00:00', NOW(), 'BATCH', 'N'),
(9,  2, '국군재정관리단', 'SALARY',  900000, '2026-01-10 09:00:00', NOW(), 'BATCH', 'N'),
(10, 2, '국군재정관리단', 'SALARY',  900000, '2026-02-10 09:00:00', NOW(), 'BATCH', 'N'),
(11, 2, '국군재정관리단', 'SALARY',  900000, '2026-03-10 09:00:00', NOW(), 'BATCH', 'N'),
(12, 2, '국군재정관리단', 'SALARY',  900000, '2026-04-10 09:00:00', NOW(), 'BATCH', 'N'),
(13, 2, '국군재정관리단', 'SALARY',  900000, '2026-05-10 09:00:00', NOW(), 'BATCH', 'N'),
(14, 2, '국군재정관리단', 'SALARY',  900000, '2026-06-10 09:00:00', NOW(), 'BATCH', 'N'),
(15, 2, '국군재정관리단', 'SALARY', 1200000, '2026-07-10 09:00:00', NOW(), 'BATCH', 'N'),
(16, 2, '국군재정관리단', 'SALARY', 1200000, '2026-08-10 09:00:00', NOW(), 'BATCH', 'N'),
-- 회원3 (2026-02 입대)
(17, 3, '국군재정관리단', 'SALARY',  750000, '2026-03-10 09:00:00', NOW(), 'BATCH', 'N'),
(18, 3, '국군재정관리단', 'SALARY',  900000, '2026-04-10 09:00:00', NOW(), 'BATCH', 'N'),
(19, 3, '국군재정관리단', 'SALARY',  900000, '2026-05-10 09:00:00', NOW(), 'BATCH', 'N'),
(20, 3, '국군재정관리단', 'SALARY',  900000, '2026-06-10 09:00:00', NOW(), 'BATCH', 'N'),
(21, 3, '국군재정관리단', 'SALARY',  900000, '2026-07-10 09:00:00', NOW(), 'BATCH', 'N'),
(22, 3, '국군재정관리단', 'SALARY',  900000, '2026-08-10 09:00:00', NOW(), 'BATCH', 'N');
