...
-- --------------------------------------------------------------------
--  [수연] 수입 income (급여) - 테스트/시연용 mock
--  실제로는 오픈뱅킹 연동 시 saveSalaries가 계급별 급여를 매월 10일 동적 적재
--  spending(지출)과 대칭이 맞아야 후회소비 수입대비 비율이 계산됨
--  회원1=상병(120만)·회원2=병장(150만)·회원3=일병(90만), 최근 3개월(5~7월)
-- --------------------------------------------------------------------
INSERT INTO income (income_id, user_id, source, category, amount, received_at, created_date, created_nm, del_yn) VALUES
(1, 1, '국군재정관리단', 'SALARY', 1200000, '2026-05-10 09:00:00', NOW(), 'BATCH', 'N'),
(2, 1, '국군재정관리단', 'SALARY', 1200000, '2026-06-10 09:00:00', NOW(), 'BATCH', 'N'),
(3, 1, '국군재정관리단', 'SALARY', 1200000, '2026-07-10 09:00:00', NOW(), 'BATCH', 'N'),
(4, 2, '국군재정관리단', 'SALARY', 1500000, '2026-05-10 09:00:00', NOW(), 'BATCH', 'N'),
(5, 2, '국군재정관리단', 'SALARY', 1500000, '2026-06-10 09:00:00', NOW(), 'BATCH', 'N'),
(6, 2, '국군재정관리단', 'SALARY', 1500000, '2026-07-10 09:00:00', NOW(), 'BATCH', 'N'),
(7, 3, '국군재정관리단', 'SALARY', 900000, '2026-05-10 09:00:00', NOW(), 'BATCH', 'N'),
(8, 3, '국군재정관리단', 'SALARY', 900000, '2026-06-10 09:00:00', NOW(), 'BATCH', 'N'),
(9, 3, '국군재정관리단', 'SALARY', 900000, '2026-07-10 09:00:00', NOW(), 'BATCH', 'N');
